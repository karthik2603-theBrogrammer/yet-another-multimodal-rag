  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`fixed top-14 left-0 h-[calc(100vh-3.5rem)] bg-background overflow-hidden z-50 lg:relative lg:top-0 lg:h-full border-r ${isSidebarOpen ? ' w-max-[350px]' : ''
          }`}
      >
        <motion.div
